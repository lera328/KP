...
urlpatterns = [
    ...
    path("makeups/admin/absences-and-slots/", admin_absences_and_slots_view, name="makeups-admin-absences-slots"),
    path("makeups/<int:request_id>/parent-cancel/", parent_cancel_makeup_view, name="makeups-parent-cancel"),
